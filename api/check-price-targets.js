...
export default async function handler(req, res) {
    ...
    try {
        // Fetch all active watchlist items (buy_triggered or sell_triggered still false)
        ...
        // Fetch current prices from the single NEPSE endpoint
        ...
        for (const update of updatesToProcess) {
            ...
            // Mark the specific target as triggered
